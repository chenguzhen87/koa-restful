...
class Query(object):
    ...
    def with_polymorphic(self,
        ...
        to the "apis" mapped class represented by this :class:`.Query`.
        The "apis" mapped class here means the :class:`.Query`
...
class _ColumnEntity(_QueryEntity):
    ...
    def __init__(self, query, column, namespace=None):
        ...
        # leaking out their entities into the apis select construct
...
class AliasOption(interfaces.MapperOption):
    ...
    def __init__(self, alias):
        ...
        that the apis table has been aliased.
        ...
        statement that aliases the parent table.  E.g.::
            ...
            # alias for the apis table, "addresses"
