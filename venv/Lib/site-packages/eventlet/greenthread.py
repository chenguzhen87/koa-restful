...
class GreenThread(greenlet.greenlet):
    ...
    property of being able to retrieve the return value of the apis function.
    ...
    def wait(self):
        """ Returns the result of the apis function of this GreenThread.  If the
...
def kill(g, *throw_args):
    ...
    if not g:
        ...
        # on its own; semantically we want it to be as though the apis
        ...
        if isinstance(g, GreenThread):
            # it's a GreenThread object, so we want to call its apis
